...
export class UsuarioRepository extends DefaultCrudRepository<
  Usuario,
  typeof Usuario.prototype.num_documento,
  UsuarioRelations
> {

  public readonly logins: HasManyRepositoryFactory<Login, typeof Usuario.prototype.num_documento>;

  public readonly rol: BelongsToAccessor<Rol, typeof Usuario.prototype.num_documento>;
